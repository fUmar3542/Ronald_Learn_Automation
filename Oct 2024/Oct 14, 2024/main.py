...
#     product_index = product_list[0].index(name)
#     product_list_indexes.append(product_index)
#     item = product_list[0][product_index]
#     price = product_list[1][product_index]
#     total_price = quantity_int * int(price)
#
# print(product_list_indexes)
...
# # The area or the block of code in which the value of the variable is accessible.
#
# # Local variables vs global variables
#
# # Global variables
# # The variables in python which are created in the leftmost indentation at the start of our program
#
# # Local variables
# # The variables in python which are created in some specific block of code and they are only accessible
...
# You have to write a program in Python in which you'll be getting 5
# integers as an input from the user and you'll be printing their sum
# and their product on console at the end of the program.
