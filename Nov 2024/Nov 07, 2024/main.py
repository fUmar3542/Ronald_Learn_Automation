...
# for num in range(numbers_list[0], numbers_list[-1] + 1):
#     if num <= 9:
#         single_number_list.append(num)
#         print(f"Sum of Digit {num} = {num}")
#     elif num == 10:
#         ten_digit_sum = 1
#         double_digit_list.append(ten_digit_sum)
#         check = 1
#         print(f"Sum of Digit {num} = {ten_digit_sum}")
#     elif num > 10:
#         first_digit = num // 10
#         last_digit = num % 10
#         result = first_digit + last_digit
#         print(f"Sum of Digit {num} = {result}")
#         double_digit_list.append(result)
#
# print("")
# print(f"Single Digit List: {single_number_list}")
# if result != 0 and check != 1:
#     pass
# else:
#     print(f"Double Digit List: {double_digit_list}")




#######################################################
numbers_list = [1882, 89]
result_list = []
